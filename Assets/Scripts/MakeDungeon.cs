...
public class MakeDungeon : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        GameObject startObj = Instantiate(start, new Vector2(0,0), Quaternion.identity) as GameObject;//startPos[0],startPos[1]
        GameObject goalObj = Instantiate(goal, new Vector2(20,20), Quaternion.identity) as GameObject;//goalPos[0],goalPos[1]
