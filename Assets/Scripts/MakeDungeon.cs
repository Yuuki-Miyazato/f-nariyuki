...
public class MakeDungeon : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        GameObject startObj = Instantiate(start, new Vector2(startPos[0],startPos[1]), Quaternion.identity) as GameObject;
        GameObject goalObj = Instantiate(goal, new Vector2(goalPos[0],goalPos[1]), Quaternion.identity) as GameObject;
